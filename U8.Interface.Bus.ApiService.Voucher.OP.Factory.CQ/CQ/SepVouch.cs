...
{
    /// <summary>
    /// 拆卸单(HY_DZ_K7_DLLReflect预置的op类)
    /// </summary>
    public class SepVouch : StockOP
    {
        ...
        private string cardNo = "0309";
        private string headtable = "MES_CQ_AssemVouchRet";
        private string bodytable = "MES_CQ_AssemVouchRets";
        private string voucherTypeName = "拆卸单";
