...
set @ParentAppTypeID=@AppTypeID 
set @AppTypeID=0 
select @AppTypeID=ID from IB_AppType where AppType='SepVouch' and AppSysID=@AppSysID 
if @AppTypeID is null or @AppTypeID=0 
begin 
insert into IB_AppType(AppType,FriendName,AppSysID)values('SepVouch','拆卸单',@AppSysID) 
select @AppTypeID=@@identity 
if @ParentAppTypeID>0 
begin 
update IB_AppType set ParentID=@ParentAppTypeID where ID=@AppTypeID 
...
set @ParentAppTypeID=@AppTypeID 
select @AppTagID=ID from IB_AppTag where AppTag='HY_ME_SVREvent.BeforeAssemAudit' and AppTypeID=@AppTypeID 
if @AppTagID is null 
begin 
insert into IB_AppTag(AppTag,FriendName,AppTypeID,ExtendProperties,Description,Customize,IsPlugin) 
 values('HY_ME_SVREvent.BeforeAssemAudit','Mes服务组装单审核前事件',@AppTypeID,'','',0,1) 
set @AppTagID=@@identity 
end 
else 
begin 
...
set @ParentAppTypeID=@AppTypeID 
select @AppTagID=ID from IB_AppTag where AppTag='HY_ME_SVREvent.BeforeAssemUnAudit' and AppTypeID=@AppTypeID 
if @AppTagID is null 
begin 
insert into IB_AppTag(AppTag,FriendName,AppTypeID,ExtendProperties,Description,Customize,IsPlugin) 
 values('HY_ME_SVREvent.BeforeAssemUnAudit','Mes服务组装单审核前事件',@AppTypeID,'','',0,1) 
set @AppTagID=@@identity 
end 
else 
begin 
