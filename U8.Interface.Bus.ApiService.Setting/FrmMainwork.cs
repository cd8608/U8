...
{
    public partial class FrmMainwork : Form
    {
        private bool bInit;
        private int iSecond;
        private int curRow;
        ...
        public FrmMainwork(string cAddress, string Acc_ID, string cOrderType, string cCode)
        {
            InitializeComponent();
        ...
        private void FrmMainwork_Load(object sender, EventArgs e)
        {
            this.Hide();
#if DEBUG
        ...
        private void FrmMainwork_Shown(object sender, EventArgs e)
        {
            if (!Common.bIsValid)
            {
                Application.Exit();
        ...
        private void FrmMainwork_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
            this.Opacity = 0;
            //this.Refresh();
