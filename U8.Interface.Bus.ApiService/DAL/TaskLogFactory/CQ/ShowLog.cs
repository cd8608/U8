...
namespace U8.Interface.Bus.ApiService.DAL.TaskLogFactory.CQ
{
    public class ShowLog : IShowLog
    {
        ...
        public DataSet GetList(string Top, string strWhere, string order, string ascOrDesc)
        {
            ...
            strSql.Append(" * FROM (");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'销售发货单' as cvouchertype,'01' as cvouchertypecode, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            ...
            strSql.Append(" cdlcode as cvoucherno,");
            strSql.Append(" cerrordesc,cRemark FROM MES_CQ_DispatchList WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'销售退货单' as cvouchertype, '03' as cvouchertypecode,createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append(" id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cdlcode as cvoucherno,");
            strSql.Append(" cerrordesc,cRemark FROM MES_CQ_DispatchListRet WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'产成品入库单' as cvouchertype,'0411' as cvouchertypecode, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'产成品入库单(红字)' as cvouchertype, '0411_Ret' as cvouchertypecode,createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            ...
            strSql.Append(" cRdCode as cvoucherno,");
            strSql.Append("cerrordesc,cRemark FROM MES_CQ_rdrecord10Ret WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'采购入库单' as cvouchertype, '24' as cvouchertypecode,createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,");
            strSql.Append("case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cRdCode as cvoucherno,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'其它入库单' as cvouchertype,'0301' as cvouchertypecode, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,");
            strSql.Append("case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cRdCode as cvoucherno,");
            strSql.Append(" cerrordesc,cRemark FROM MES_CQ_rdrecord08 WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'材料出库单' as cvouchertype, '0412' as cvouchertypecode,createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            ...
            strSql.Append(" cRdCode as cvoucherno,");
            strSql.Append("cerrordesc,cRemark FROM MES_CQ_RdRecord11 WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'其它出库单' as cvouchertype, '0302' as cvouchertypecode,createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,");
            strSql.Append("createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cRdCode as cvoucherno,");
            strSql.Append("cerrordesc,cRemark FROM MES_CQ_RdRecord09 WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'调拨单' as cvouchertype,'0304' as cvouchertypecode, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,");
            strSql.Append("case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" ctvcode as cvoucherno,");
            strSql.Append("cerrordesc,cRemark FROM MES_CQ_TransVouch WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'盘点单' as cvouchertype,'0307' as cvouchertypecode,");
            ...
            //strSql.Append(" UNION ALL ");
            //strSql.Append(" SELECT ");
            //strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'组装单' as cvouchertype,'0308' as cvouchertypecode,");
            //strSql.Append(" createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            //strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            //strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,");
            //strSql.Append("createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            //strSql.Append(" cCVCode as cvoucherno,");
            //strSql.Append("cerrordesc,'' AS cRemark FROM MES_CQ_AssemVouch WITH(NOLOCK) ");
            //strSql.Append(" UNION ALL ");
            //strSql.Append(" SELECT ");
            //strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'拆卸单' as cvouchertype,'0309' as cvouchertypecode,");
            //strSql.Append(" createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            //strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            //strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,");
            //strSql.Append("createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            //strSql.Append(" cCVCode as cvoucherno,");
            //strSql.Append("cerrordesc,'' AS cRemark FROM MES_CQ_AssemVouchRet WITH(NOLOCK) ");
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
