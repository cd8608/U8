...
namespace U8.Interface.Bus.ApiService.DAL.TaskLogFactory.CQ
{
    public class ShowLog : IShowLog
    {
        ...
        public DataSet GetList(string Top, string strWhere, string order, string ascOrDesc)
        {
            ...
            strSql.Append(" * FROM (");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'销售发货单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            ...
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'销售退货单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append(" id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cdlcode as cvoucherno,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'产成品入库单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'采购入库单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,");
            strSql.Append("case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cRdCode as cvoucherno,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'材料出库单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'其它出库单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,");
            strSql.Append("createTime,finishTime,case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            strSql.Append(" cRdCode as cvoucherno,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'调拨单' as cvouchertype, createTime as starttime,finishTime as endtime,'' as Cacc_Id,");
            strSql.Append(" '' as Cacc_Name , '' as Caddress, ");
            strSql.Append("   id,CASE  operflag WHEN 0 THEN '未处理' WHEN 1 THEN '完成' WHEN 2 THEN '处理中' WHEN 3 THEN '错误' ELSE '已作废' END AS cstatus,createTime,finishTime,");
            strSql.Append("case opertype when   0 then '增加' WHEN 1 THEN '修改' else '删除' end   as opertype,");
            ...
            strSql.Append(" UNION ALL ");
            strSql.Append(" SELECT ");
            strSql.Append(" '' as cserialno,'' as croutetype,'' as caccid,'盘点单' as cvouchertype,");
