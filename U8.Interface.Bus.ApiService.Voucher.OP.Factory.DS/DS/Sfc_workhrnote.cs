...
{
    /// <summary>
    /// 工时记录单(HY_DZ_K7_DLLReflect预置的op类)
    /// </summary>
    public class Sfc_workhrnote : SfcOp
    {
        ...
        /// 任务状态标记符
        /// </summary>
        private string taskStatusflagColName = "operflag_work";
        private string taskErrorMsgColName = "cerrordesc_work";
        #endregion
        ...
        public override string SubEntityName
        {
            get
            {
                return "WorkhrNoteOpSum";
            }
            set { }
        }
        public override string SetTableName()
        {
            return "Sfc_workhrnote";
        }
        ...
        {
            return "U8API/WorkHrNote/WorkHrNoteAdd";
        }
        ...
        {
            return "U8API/WorkHrNote/WorkHrNoteDelete";
        }

        public override string SetApiAddressLoad()
        {
            return "U8API/WorkHrNote/WorkHrNoteLoad";
        }
        ...
        public override System.Data.DataSet SetFromTabet(Model.Synergismlogdt dt, Model.Synergismlogdt pdt, Model.APIData apidata)
        {
            ...
            sql += " '" + System.DateTime.Now.ToString(SysInfo.dateFormat) + "' as VAR_DocDate ";   //移库日期
            sql += ",'" + System.DateTime.Now.ToString(SysInfo.datetimeFormat) + "' as VAR_DocTime, ";   //制单时间
        ...
        { 
            ...
            strSql.Append(" " + taskStatusflagColName + " = " + operflag + "  ");
        ...
        public override int Update(Model.Synergismlogdt dt)
        {
            ...
            strSql.Append(" " + taskStatusflagColName + " = " + operflag + ",  ");
            strSql.Append(" " + taskErrorMsgColName + " = '" + dt.Cerrordesc + "'  ");
            strSql.Append(" where id=" + dt.Id + " ");
